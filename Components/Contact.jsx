...
const Contact = () => {
  ...
  const [state, handleSubmit] = useForm("xrbzwgrb");
    ...
    <section id="contact" className="ico-contact pos-rel">
      <div className="container">
        <div className="ico-contact__wrap">
          <h2 className="title">Contact with 1MPro</h2>

          <form onSubmit={handleSubmit}>
            <div className="row">
              <div className="col-lg-6">
                <input type="text" id="name" name="name" placeholder="Ether name"/>
              </div>
              ...
              <div className="ico-contact__btn text-cente mt-10r">
                <button 
                  className="thm-btn"
                  type="submit"
