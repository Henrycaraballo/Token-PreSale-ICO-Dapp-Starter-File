...
const Hero = ({
  ...
  useEffect(() => {
    const calculatePercentage = () => {
      ...
      if (tokenTotalSupply === 0) {
        consele.log("Token sale balance is zero, cannot calculate percentage");
      } else{
  ...
  return ( 
    <section className="hero hero__ico pos-rel">
      ...
      data-background="asset/img/bg/hero_bg.png" />

      <div className="container">
        <div className="row">
          <div className="col-lg-7">
            <div className="hero__content">
              <hi className="title mb-45">
              ...
              <div className="hero__progress mt-50">
                <div className="progress-title ul_li_between">
                  ...
                  <span>
                    <span>Total ICO -</span> {detail?.soldTokens + Number(detail?.tokenBal)}{" "}
                    {detail?.symbol}
                  </span>
                </div>
