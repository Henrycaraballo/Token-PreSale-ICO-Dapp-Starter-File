    ...
    <section className="team pos-rel">
        ...
        <div className="new-owner team__wrap ul_li">
          <div className="team__item">
            ...
            <div className="team__social ul_li_center">
              <span onClick={() => (setOwnerModel (false), setTransferModel(true))} 
              className="h-icon"
              style={{
                cursor: "pointer",
              }}
          ...
          {account == detail?.owner && (
           ...
           <div className="team__item">
                ...
                <div className="team__info text-center mb-20">
                  <h3>WITHDRAW</h3>
                <span>
                   ICO TOKEN, Only Owner</span>
                </div>

                <div className="team__social ul_li_center">
                  <span 
                    onClick={() => TOKEN_WITHDRAW (account)} 
                    className="h-icon"
                    style={{
                    cursor: "pointer",
                    }}
      ...
      <div className="team__shape">
        <div className="shape shape--1">
          <img src="assets/img/t_shape1.png" alt="" />
        </div>

        <div className="shape shape--2">
          <img src="assets/img/t_shape2.png" alt="" />
        </div>
      </div>
    </section>
  )
