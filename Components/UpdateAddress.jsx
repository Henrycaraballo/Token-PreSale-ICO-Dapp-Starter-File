      ...
      <div className="container">
        <div className="ico-contact__wrap">
          ...
          <div>
            ...
            <p>
              <strong>Current Price</strong> {detail?.tokenPrice} {currency} &nbsp; &nbsp; <strong>Token Balance</strong> {detail?.tokenBal}{" "}{detail.symbol} &nbsp; &nbsp; {" "}
              <strong
                onClick={() => 
            ...
            <div className="ico-contract_btn text-center at-10">
