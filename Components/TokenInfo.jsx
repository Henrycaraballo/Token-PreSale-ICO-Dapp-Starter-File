        ...
        <div className="row">
          <div className="col-xl-8 offset-xl-4">
            <div className="token-info__title sec-title mb-95 text-center text-xl-start">
              <h5 className="sec-title__subtitle">ICO 1MPro TOKEN</h5>
              <h2 className="sec-title__title">ICO Token <br /> Details and sale
              </h2>
            </div>
          </div>
        </div>
          ...
          <div className="col-lg-8">
            <div className="token-info--info-wrap">
              <ul className="token-info__list token-info--start">
                ...
                <li>
                  <h4>Sold Token</h4>
                  <span>{Number(detail?.soldTokens)} {detail?.symbol}
                  </span>
                </li>
                <li>
                  <h4>Minimal Transaction</h4>
                  <span>10 Token / Transaction
                  </span>
                </li>
              </ul>
              <ul className="token-info__list token-info__end">
                <li>
                  <h4>Token Market Valu</h4>
                  <span>{Number(detail?.supply) * Number(detail?.tokenPrice)}
                    {currency}
                  </span>
                </li>
                <li>
                  <h4>Funds Raised</h4>
                  <span>{Number(detail?.soldTokens) * Number(detail?.tokenPrice)}
                    {currency}
                  </span>
                </li>
                <li>
                  <h4>Acceptable currencies</h4>
                  <span>ETH, BTC, USDT, BNB, USDC</span>
                </li>
              </ul>
            </div>
          </div>
